...
class Img2SeqModel(BaseModel):
    ...
    def _add_placeholders_op(self):
        ...
        # input of the graph
        self.img = tf.compat.v1.placeholder(tf.uint8, shape=(None, None, None, 1), name='img')
        self.formula = tf.compat.v1.placeholder(tf.int32, shape=(None, None), name='formula')
        self.formula_length = tf.compat.v1.placeholder(tf.int32, shape=(None, ), name='formula_length')
    ...
    def _add_loss_op(self):
        ...
        self.ce_words = tf.reduce_sum(input_tensor=losses)   # sum of CE for each word
        self.n_words = tf.reduce_sum(input_tensor=self.formula_length)   # number of words
